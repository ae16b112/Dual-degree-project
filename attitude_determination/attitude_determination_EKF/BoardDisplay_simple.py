...
#run Kalman_EKF and Wireframe_simple before running this file
"""
...
class ProjectionViewer:
    ...
    def __init__(self, width, height, wireframe):
        ...
        self.background = (192, 192, 192) # (255, 255, 204)
        ...
        while running:
            with open("sensor_data.csv", "r") as f:
                ...
                for i, line in enumerate(reader):
                    ...
                    self.wireframe.quatRotate([float(data[0]), float(data[1]), float(data[2])],
...
def initializeCube():
    ...
    node_colors = [(255, 0, 255)] * len(block_nodes)
    block.addNodes(block_nodes, node_colors)
    block.outputNodes()

    faces = [(0, 2, 6, 4), (0, 1, 3, 2), (1, 3, 7, 5), (4, 5, 7, 6), (2, 3, 7, 6), (0, 1, 5, 4)]
    colors = [(255, 204, 204), (204, 255, 204), (255, 204, 255), (204, 204, 255), (204, 255, 255), (255, 255, 204)]
